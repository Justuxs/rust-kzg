use std::ops::Neg;
use crate::kzg_types::{EmptyScalar, ZG1, ZG2};
...
pub(crate) const MODULUS: EmptyScalar = EmptyScalar([
...
pub const R2: EmptyScalar = EmptyScalar([
...
/** The G1 generator */
pub const G1_GENERATOR: ZG1 = ZG1::from_g1_projective(G1Projective::generator());

pub const G1_NEGATIVE_GENERATOR: ZG1 =  ZG1::from_g1_projective(G1Projective::generator().neg());
#[rustfmt::skip]
pub const G1_IDENTITY: ZG1 = ZG1::from_g1_projective(G1Projective::identity());

pub const G2_GENERATOR: ZG2 = ZG2::from_g2_projective(G2Projective ::generator());

pub const G2_NEGATIVE_GENERATOR: ZG2 = ZG2::from_g2_projective(G2Projective ::generator().neg());
